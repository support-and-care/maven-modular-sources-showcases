# Blog 2: Encapsulation – Hiding Implementation Details

In the [first article](https://open-elements.com/posts/2026/01/27/your-first-modular-java-project-with-apache-maven-4/) (and its [homework extension](https://open-elements.com/posts/2026/02/26/java-modules-maven4-basics-homework/)), we built a modular Java project with Maven 4 and exported all packages from our core module.
...
![Module dependencies](images/module-structure-2.svg)
...
This article is published on the [Open Elements blog](https://open-elements.com/posts/2026/03/12/java-modules-encapsulation-internal-packages/).
