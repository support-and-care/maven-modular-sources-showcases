...
In the [previous article](blog-1-basics.md), we left you with two homework assignments.
...
The [module source hierarchy](blog-1-basics.md#the-module-source-hierarchy) places resources in `src/<module>/main/resources/`, but Maven’s core resource handling doesn’t yet recognize this convention.
...
This article is published on the [Open Elements blog](https://open-elements.com/posts/2026/02/26/java-modules-maven4-basics-homework/).
